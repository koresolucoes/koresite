    ...
    <main className="min-h-screen bg-gradient-to-br from-kore-azul via-kore-cinza to-black pb-0">
      ...
      <section className="flex flex-col items-center justify-center text-center py-16 md:py-20 relative">
        ...
        <div className="relative z-10 flex flex-col items-center">
          ...
          <h1 className="text-4xl md:text-5xl font-black mb-4 text-kore-ciano">Integrações Avançadas</h1>
          <p className="text-lg md:text-xl text-kore-branco mb-6 max-w-2xl">Domine integrações complexas, APIs, webhooks e automações personalizadas no n8n.</p>
        </div>
      </section>
      ...
      <section className="max-w-3xl mx-auto px-4 py-8">
        <div className="bg-kore-ciano/10 rounded-2xl p-8 shadow-xl">
          <ul className="list-disc pl-6 text-gray-300 mb-4">
            <li><span className="font-bold text-kore-destaque">Público-alvo:</span> Profissionais de TI, desenvolvedores, empresas</li>
            <li><span className="font-bold text-kore-destaque">Pré-requisitos:</span> Conhecimento prévio em n8n</li>
            <li><span className="font-bold text-kore-destaque">Formato:</span> Vídeo aulas, projetos práticos, suporte ao aluno</li>
          </ul>
      ...
      <section className="max-w-3xl mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-black bg-opacity-40 rounded-xl p-6 flex flex-col items-center shadow-lg">
            <span className="font-bold text-ciano-eletrico mb-2">Projetos reais</span>
            <span className="text-gray-300 text-center text-sm">Aprenda com exemplos usados no mercado.</span>
          </div>
          <div className="bg-black bg-opacity-40 rounded-xl p-6 flex flex-col items-center shadow-lg">
            <span className="font-bold text-ciano-eletrico mb-2">Mentoria e Suporte</span>
            <span className="text-gray-300 text-center text-sm">Acesso direto ao instrutor para tirar dúvidas.</span>
          </div>
          <div className="bg-black bg-opacity-40 rounded-xl p-6 flex flex-col items-center shadow-lg">
            <span className="font-bold text-ciano-eletrico mb-2">Certificado</span>
            <span className="text-gray-300 text-center text-sm">Reconhecimento para sua carreira.</span>
          </div>
        </div>
      </section>
      ...
      <section className="max-w-2xl mx-auto px-4 py-12">
        ...
        <div className="bg-kore-cinza/90 rounded-xl p-8 flex flex-col items-center shadow-xl">
          <Image src="/expertise/blog-images/aluno-exemplo2.jpg" alt="Aluno satisfeito" width={64} height={64} className="rounded-full mb-4 shadow-lg border-2 border-kore-ciano" />
          <blockquote className="italic text-gray-200 text-center mb-2">“O curso de Integrações Avançadas da Kore me permitiu criar automações que nunca imaginei. Suporte excelente!”</blockquote>
          <span className="font-bold text-kore-destaque">Bruna Lima</span>
      ...
      <section className="w-full flex justify-center py-10 bg-gradient-to-t from-black via-kore-cinza to-transparent">
        <div className="bg-kore-ciano/90 rounded-2xl p-8 flex flex-col md:flex-row items-center gap-6 shadow-xl max-w-2xl w-full">
          <div className="flex-1 text-center md:text-left">
            <h3 className="text-2xl font-bold text-kore-azul mb-2">Quer dominar integrações avançadas?</h3>
            <p className="text-kore-azul mb-2">Fale com a equipe Kore e tire suas dúvidas sobre o curso.</p>
